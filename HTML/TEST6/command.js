...
{
    FrameGround.ImportObjGround("../../ASSETS/SCENE/","ObjGround3.babylon",func,obj_ground,true);
}
var cig=command.importObjGround;
command.importObjGround2=function(func)
{
    FrameGround.ImportObjGround(MyGame.mapData.mapScenePath,MyGame.mapData.mapSceneName,func,obj_ground,true);
}
...
{
    newland.importScripts("./additionalscript.js");
}
